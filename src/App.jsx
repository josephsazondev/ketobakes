    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={S.screen}>
        <div style={{ padding: '16px 16px 40px' }}>
          ...
          <div style={S.group}><label style={S.label}>API Key (optional — must match Config sheet)</label><input style={S.input} value={form.apiKey || ''} placeholder="Leave blank if not set" onChange={e => set('apiKey', e.target.value)} /></div>
